function Equipe() {
  return (
    <div className="md:px-14 p-4 max-w-s space-y-12 bg-gray-100">
      <div className=" my-10 mx-auto md:px-6">
        <section className="mb-32 text-center">
          <h2 className="mb-32 text-3xl md:text-4xl font-extrabold text-blue-800">
            Notre Equipe
          </h2>
          <div className="grid gap-x-6 md:grid-cols-3 lg:gap-x-12">
            <div className="mb-24 md:mb-0">
              <div className="block h-full rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(19, 24, 79, 0.04)]">
                <div className="flex justify-center">
                  <div className="flex justify-center -mt-[75px]">
                    <img
                      src="../public/TEAM/5.png"
                      className="mx-auto rounded-full shadow-lg w-[100px] md:w-[150px]"
                      alt="Avatar"
                    />
                  </div>
                </div>
                <div className="p-6">
                  <h5 className="mb-4 text-lg font-bold">Océan KALALA</h5>
            ...
            <div className="mb-24 md:mb-0">
              <div className="block h-full rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(10, 17, 87, 0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700">
                <div className="flex justify-center">
                  <div className="flex justify-center -mt-[75px]">
                    <img
